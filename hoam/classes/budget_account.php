...
class HOAM_budget_account extends HOAM_common {
	...
	function changeAccountNum ($id, $value) {
		return ($this -> changeString ($id, 'account_num', $value));
	}
	...
	function returnAccountNum ($id) {
		return ($this -> returnItem ($id, 'account_num'));
	}
