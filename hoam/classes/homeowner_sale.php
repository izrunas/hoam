...
class HOAM_homeowner_sale extends HOAM_common {
	...
	function changeTitleCompany ($id, $value) {
		return ($this -> changeString ($id, 'title_company', $value));
	}
	...
	function returnTitleCompany ($id) {
		return ($this -> returnItem ($id, 'title_company'));
	}
}
