...
if (isset ($_GET['id'])) {
	...
	if (isset ($_SESSION['current_user']['id']) AND
		...
		$trusted_id = $news_class -> superClean ($_GET['id'], $news_class -> returnColumnSize ('id'));
		$history_list = $_HOAM_log -> listOwnerBit ($trusted_id, (int) $_HOAM_setting ['log']['flags']['news']);
