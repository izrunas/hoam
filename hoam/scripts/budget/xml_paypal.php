...
// We're only going to do basic authentication on this. There really isn't
// anything 'private' about the PayPal amounts details
if (isset ($_SESSION['current_user']['id']) AND
	...
	xmlwriter_start_element ($xw, 'paypal');
	xmlwriter_write_element ($xw, 'enable', $_HOAM_setting ['budget']['paypal']['enable']);
	xmlwriter_write_element ($xw, 'email', $_HOAM_setting ['budget']['paypal']['email']);
	xmlwriter_write_element ($xw, 'surcharge_amount', $_HOAM_setting ['budget']['paypal']['surcharge']['amount']);
	xmlwriter_write_element ($xw, 'surcharge_percent', $_HOAM_setting ['budget']['paypal']['surcharge']['percent']);
	xmlwriter_end_element ($xw); // paypal
