...
/*
 *
 * This file simply checks to see whether a given accountname has been banned.
 *
 */
...
if (isset ($_GET['account'])) {
	...
	if (HOAM_userNameBanned ($trusted_accountname)) {
		// One, or TRUE, the accountname has been banned.
		echo '1';
	} else {
		// Zero, or FALSE, the accountname is ok.
		echo '0';
	}
}
